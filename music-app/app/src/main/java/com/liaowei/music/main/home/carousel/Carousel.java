    ...
    public void initViews(int[] resource) {
        ...
        for (int id : resource) {
            ...
            if (originalImages.size() == 1) {
                dotImageView.setImageResource(R.drawable.dot_light);
            } else {
                dotImageView.setImageResource(R.drawable.dot_gray);
            }
        ...
        viewPager2.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                for (int i = 0; i < mDotViewList.size(); i++) {
                    ...
                    if (i == position - 1) {
                        mDotViewList.get(i).setImageResource(R.drawable.dot_light);
                    } else {
                        mDotViewList.get(i).setImageResource(R.drawable.dot_gray);
                    }
                }
